...
import { Upload, FileText, Link as LinkIcon, Loader2, CheckCircle2, Sparkles } from "lucide-react";
            ...
            <div className="space-y-3 animate-fade-in">
              ...
              <div className="flex gap-2">
                <div className="flex-1 flex items-center gap-2 rounded-lg border bg-background px-3 py-2">
                  ...
                  <input
                    type="url"
                    placeholder={selected === 'notion' ? 'https://notion.so/your-page...' : 'https://docs.google.com/...'}
                    value={url}
          ...
          {state === 'done' ? (
            ...
            <>
              ...
              <p className="text-sm font-medium text-foreground">
                {state === 'connecting' && 'Connecting to source…'}
